...
| `components/` | WMDS composition: Pattern — creator Insights shell (hug SegmentedControl + in-page PitchKit Coming soon), Insights body (`PageHeader`, Stat, Chart, Recent proof), shareable kit freeze, creator identity nameplate + Settings card |
...
```bash
npm install github:thewhatmatters/wmds#0718bdcb87975d3389ad11770bb479c293d33200
```
