...
4. They land on **Insights** (private). Pattern header is PitchKit + hug SegmentedControl (Insights / PitchKit) + Avatar. **PitchKit** is an in-page preview of the shareable kit. Account is a quiet footer link.
...
| `components/` | WMDS composition: Pattern — creator Insights shell (hug SegmentedControl + in-page PitchKit preview), Insights body (`PageHeader`, Stat, Chart, Recent proof), shareable kit freeze + owner Edit |
...
```bash
npm install github:thewhatmatters/wmds#75f8a41e8b131906378b340a4106a486ddd5173f
```
