...
Locks → [PLAN.md](./PLAN.md). Picture → [ARCHITECTURE.md](./ARCHITECTURE.md). Columns → [DATA.md](./DATA.md). Stats words → [GLOSSARY.md](./GLOSSARY.md). Kit-space SWOT → [SWOT.md](./SWOT.md). Free promise → [LIGHTS-ON.md](./LIGHTS-ON.md). IA → [IA.md](./IA.md). Humans → [README.md](./README.md).
