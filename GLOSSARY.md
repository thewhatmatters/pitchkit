...
- Hide: until Insights (graph-unavailable omits the optional chart region). Empty / thin / all-zero with Insights → keep the Reach Card and show **No reach data yet**. Empty > zeros. Do not invent hatched in-series gaps.
