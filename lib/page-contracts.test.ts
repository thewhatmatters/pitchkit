...
describe("critical page contracts", () => {
  ...
  it("Insights chrome matches creator Insights pattern", () => {
    ...
    assert.match(read("package.json"), /wmds#70da6a4c50d8efc1e687b20f231c6e4f1f6190c6/);
    assert.doesNotMatch(
      read("package.json"),
      /dc813326028c0fe1cc5f3719466a32607bab4504|55944edfc8039b6682882c65d1a956b1e51fba21|75f8a41e8b131906378b340a4106a486ddd5173f|3f13630|73277bab/,
    );
